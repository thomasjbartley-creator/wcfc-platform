      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '32px 20px' }}>
        ...
        {!isPaid && (
          <div style={{ background: 'rgba(229,57,53,0.08)', border: '1px solid rgba(229,57,53,0.25)', borderRadius: '12px', padding: '20px 24px', marginBottom: '28px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '14px' }}>
            ...
            <a href="https://buy.stripe.com/5kQdR1bxS7iL0Nr1i9dfG03" style={{ padding: '12px 24px', background: '#FFD600', color: '#050C0A', borderRadius: '6px', fontFamily: "'Bebas Neue'", fontSize: '0.95rem', letterSpacing: '2px', textDecoration: 'none', whiteSpace: 'nowrap' }}>
              👑 Champion Founder — $10
            </a>
          </div>
        )}
